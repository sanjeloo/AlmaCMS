...
DataTable.ext.buttons.copyHtml5 = {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.copy', 'کپی جدول' );
	},
	...
	action: function ( e, dt, button, config ) {
		...
		if ( document.queryCommandSupported('copy') ) {
			...
			try {
				...
				dt.buttons.info(
					dt.i18n( 'buttons.copyTitle', 'کپی در حافظه پنهان سیستم' ),
					dt.i18n( 'buttons.copySuccess', {
					    1: "یک ردیف در حافظه پنهان سیستم کپی شد.",
					    _: "%d ردیف در حافظه پنهان سیستم کپی شد."
						}, exportData.rows ),
					2000
				);
...
DataTable.ext.buttons.excelHtml5 = {
	...
	text: function ( dt ) {
	    return dt.i18n('buttons.excel', 'خروجی Excel');
	},
...
DataTable.ext.buttons.pdfHtml5 = {
	...
	text: function ( dt ) {
	    return dt.i18n('buttons.pdf', 'خروجی PDF');
	},
