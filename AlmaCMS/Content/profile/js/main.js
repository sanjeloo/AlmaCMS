...
jQuery(document).on('ready', function () {
    ...
    if (jQuery('#tg-categoriesslider').length > 0) {
        ...
        _tg_postsslider.owlCarousel({
            ...
            responsive: {
                ...
                668: { items: 5, center: false },
                768: { items: 5, center: false },
                868: { items: 7, },
            }
        });
    }
    ...
    /*--------------------------------------
			THEME COLLAPSE		اولی بعدا که دیتا زیاد شد بسته بشه			
	--------------------------------------*/
    ...
    if (jQuery('#tg-narrowsearchcollapse').length > 0) {
        var _openFirst = jQuery('.openedcloapse');
        _openFirst.collapse({
            open: function () { this.slideDown(300); },
            close: function () { this.slideUp(300); },
        });
    ...
    if (jQuery('#tg-productgallery').length > 0) {
        var gallery = new $.ThumbnailGallery(jQuery('#tg-productgallery'), {
            ...
            imageType: 'jpg',
            thumbImageType: 'jpg',
            thumbImages: '/content/images/gallery/thumbs/thumb',
            smallImages: '/content/images/gallery/small/image',
            largeImages: '/content/images/gallery/large/image',
        });
    }
    /* -------------------------------------
